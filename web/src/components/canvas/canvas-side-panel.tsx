...
export function CanvasSidePanel({ nodes, selectedNodeIds, onFocusNode, onPreviewNode, onInsertAsset, onComposeVideos, onBatchGenerate }: Props) {
        ...
        >
            ...
            >
                ...
                <div className="mt-2 min-h-0 flex-1 overflow-hidden">
                    {tab === "canvas" ? (
                        <CanvasNodesTab nodes={nodes} selectedNodeIds={selectedNodeIds} onFocusNode={onFocusNode} onPreviewNode={onPreviewNode} onComposeVideos={onComposeVideos} onBatchGenerate={onBatchGenerate} theme={theme} />
                    ) : tab === "assets" ? (
...
function CanvasNodesTab({ nodes, selectedNodeIds, onFocusNode, onPreviewNode, onComposeVideos, onBatchGenerate, theme }: { nodes: CanvasNodeData[]; selectedNodeIds: Set<string>; onFocusNode: (nodeId: string) => void; onPreviewNode: (nodeId: string) => void; onComposeVideos: (nodes: CanvasNodeData[]) => void; onBatchGenerate: (nodes: CanvasNodeData[]) => void; theme: CanvasTheme }) {
